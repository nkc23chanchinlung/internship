...
public class Cell : MonoBehaviour
{
    ...
    public void CreateCell(bool collapseState, GameObject[] tiles)
    {
        collapsed = collapseState;
        tileOptions = tiles;
    }

    public void RecreateCell(GameObject[] tiles)
    {
        tileOptions = tiles;
    }
}
...
public class WaveFunction : MonoBehaviour
{
    ...
    void CollapseCell(List<Cell> tempGrid)
    {
        ...
        GameObject selectedTile = cellToCollapse.tileOptions[UnityEngine.Random.Range(0, cellToCollapse.tileOptions.Length)];
        cellToCollapse.tileOptions = new GameObject[] { selectedTile };

        GameObject foundTile = cellToCollapse.tileOptions[0];
            ...
            for (int x = 0; x < dimensions; x++)
            {
                ...
                else
                {
                    ...
                    if (y > 0)
                    {
                        ...
                        foreach (GameObject possibleOptions in up.tileOptions)
                        {
                    ...
                    if (x < dimensions - 1)
                    {
                        ...
                        foreach (GameObject possibleOptions in right.tileOptions)
                        {
                            var valOption = Array.FindIndex(tileObjects, obj => obj == possibleOptions);
                    ...
                    if (y < dimensions - 1)
                    {
                        ...
                        foreach (GameObject possibleOptions in down.tileOptions)
                        {
                            var valOption = Array.FindIndex(tileObjects, obj => obj == possibleOptions);
                    ...
                    if (x > 0)
                    {
                        ...
                        foreach (GameObject possibleOptions in left.tileOptions)
                        {
                            var valOption = Array.FindIndex(tileObjects, obj => obj == possibleOptions);
